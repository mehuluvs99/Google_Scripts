function sendMail() {
  ...
  const sheet = SpreadsheetApp.getActiveSpreadsheet().getSheetByName("LAMY_Quotation_File");
  ...
  const tempDoc = DriveApp.getFileById("1ZbaEXOuQuw4g-Wri27B6wZAAnorZzXsrZF7Kcb7Wa70")
...
// });
  ...
  var ss = sheet3.getSheetByName("LI_Qoutation_Number")
  ...
  var ss1 = sheet4.getSheetByName("LAMY_Quotation_File")
